...
public class ContentController : ControllerBase
{
    ...
    [HttpPost]
    [Route("cms/api/v1/content/list/{repositoryId}/{definitionId}")]
    ...
    [HttpPost]
    [Route("cms/api/v1/content/filter")]
    ...
    [HttpDelete]
    [Route("cms/api/v1/content/{repositoryId}/{contentId}")]
    ...
    [HttpPut]
    [Route("cms/api/v1/contentitem/{repositoryid}")]
